...
\usepackage{geometry}
% DHBW Standard
\geometry{a4paper, top=25mm, left=30mm, right=30mm, bottom=20mm, headsep=10mm, footskip=12mm}
...
% \usepackage[backend=biber, style=ieee, sorting=nyt, isbn=false, doi=false, urldate=short, dashed=false]{biblatex} 	% Use IEEE-Style (e.g. [1])
